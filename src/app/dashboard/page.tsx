...
export default function DashboardPage() {
  ...
  function generateAndPrintDoc(dv, isFacture) {
    ...
    var css = [
      '@import url(https://fonts.googleapis.com/css2?family=Yellowtail&family=Arial+Narrow&display=swap)',
      ...
      '.logo-sub { font-size:8px; color:#aaa; margin-top:3px; text-transform:uppercase; letter-spacing:1px }',
      '.doc-type { font-family:Yellowtail,cursive; font-size:32px; color:#191923; text-align:right }',
      ...
      '.party-label { font-size:7px; font-weight:900; text-transform:uppercase; letter-spacing:2px; color:#aaa; margin-bottom:5px }',
      ...
      '.t-final .label { font-family:Yellowtail,cursive; font-size:18px; color:#191923 }',
      ...
      '.rib-title { font-family:Yellowtail,cursive; font-size:14px; color:#FF82D7; margin-bottom:8px }',
      ...
      '.conditions { font-size:9.5px; color:#555; margin-bottom:10px; line-height:1.6 }',
      '.footer-legal { border-top:1px solid #EBEBEB; padding-top:10px; margin-top:auto }',
      '.legal-text { font-size:7.5px; color:#bbb; line-height:1.6; margin-bottom:8px }',
      '.pink-footer { background:#FF82D7; padding:7px 14px; border-radius:4px; text-align:center; font-family:Yellowtail,cursive; font-size:14px; color:#191923 }',
    ...
    var html = '<!DOCTYPE html><html><head>'+
      ...
      '<div class="header">'+
        '<div class="logo">'+
          ...
          '<div class="logo-sub">Crazy Deli &nbsp;·&nbsp; New York Style</div>'+
      ...
      '<div class="parties">'+
        '<div class="party">'+
          ...
          '<div class="party-detail">edward@meshuga.fr</div>'+
        '</div>'+
