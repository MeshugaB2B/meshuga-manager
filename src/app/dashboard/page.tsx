...
export default function DashboardPage() {
  ...
  function generateAndPrintDoc(dv, isFacture) {
    ...
    var css = [
      ...
      'body { font-family: Arial, sans-serif; color: #191923; font-size: 11px; background: white; width: 210mm; margin: 0 auto }',
      '@import url(https://fonts.googleapis.com/css2?family=Yellowtail&display=swap)',
      ...
      '.logo-sub { font-size:8px; color:#aaa; margin-top:3px; letter-spacing:1px }',
      '.doc-type { font-family:Yellowtail,cursive; font-size:36px; color:#191923; text-align:right }',
      '.doc-num { font-size:10px; color:#888; text-align:right; margin-top:2px }',
      ...
      '.party-label { font-family:Yellowtail,cursive; font-size:13px; color:#aaa; margin-bottom:4px }',
      '.party-name { font-size:14px; font-weight:900; margin-bottom:3px }',
      '.party-detail { font-size:9.5px; color:#555; margin-top:1px; line-height:1.5 }',
      '.badge { display:inline-block; background:#FFEB5A; border:1.5px solid #191923; border-radius:3px; padding:2px 8px; font-size:10px; font-weight:900; margin-top:6px }',
      'table { width:100%; border-collapse:collapse; margin-bottom:14px }',
      'thead th { padding:8px 10px; font-size:8px; text-transform:uppercase; letter-spacing:1px; font-weight:900; color:#191923; border-top:2px solid #191923; border-bottom:2px solid #191923; background:white }',
      ...
      '.t-label { font-family:Yellowtail,cursive; font-size:13px }',
      '.t-final { display:flex; justify-content:space-between; padding:9px 12px; background:#FFEB5A; border:2px solid #191923; border-radius:4px; margin-top:6px }',
      '.t-final .label { font-family:Yellowtail,cursive; font-size:20px; color:#191923 }',
      '.t-final .amount { font-weight:900; font-size:16px; color:#191923 }',
      ...
      '.rib-title { font-family:Yellowtail,cursive; font-size:16px; color:#FF82D7; margin-bottom:8px }',
      ...
      '.conditions-title { font-family:Yellowtail,cursive; font-size:14px; color:#191923; margin-bottom:3px }',
      '.conditions { font-size:9.5px; color:#555; margin-bottom:14px; line-height:1.6 }',
      '.notes { background:#FFFDE7; border-left:3px solid #FFEB5A; padding:8px 12px; margin-bottom:12px; font-size:10px }',
      '.notes-title { font-family:Yellowtail,cursive; font-size:13px; margin-bottom:3px }',
      '.footer-block { margin-top:40px; padding-top:12px; border-top:1px solid #EBEBEB }',
      '.legal-text { font-size:7.5px; color:#bbb; line-height:1.7; margin-bottom:8px }',
      '.pink-footer { background:#FF82D7; padding:8px 14px; border-radius:4px; text-align:center; font-family:Yellowtail,cursive; font-size:16px; color:#191923 }',
      '.print-bar { text-align:center; padding:20px; background:#F8F8F8; border-top:2px solid #EBEBEB; margin-top:16px }',
    ].join(' ')
    ...
    var html = '<!DOCTYPE html><html><head>'+
      ...
      '<div class="header">'+
        '<div class="logo">'+
          '<img src="'+logoSrc+'" alt="meshuga">'+
          '<div class="logo-sub">Crazy Deli</div>'+
          '<div class="logo-sub">3 rue Vavin, 75006 Paris</div>'+
        '</div>'+
        '<div>'+
          '<div class="doc-type">'+titre+'</div>'+
          '<div class="doc-num">N&deg; '+numero+'</div>'+
          '<div class="doc-num">Date : '+new Date().toLocaleDateString('fr-FR')+'</div>'+
        '</div>'+
      '</div>'+
      ...
      '<div class="parties">'+
        ...
        '<div class="party client">'+
          ...
          ((dv.event_date||dv.event_lieu)?'<div class="party-detail" style="margin-top:6px"><strong>Ev&eacute;nement :</strong> '+(dv.event_date?new Date(dv.event_date).toLocaleDateString('fr-FR'):'')+(dv.event_lieu?' &mdash; '+dv.event_lieu:'')+'</div>':'')+
      ...
      '<div class="totals-wrap">'+
        '<div class="totals">'+
          '<div class="t-row"><span class="t-label">Total HT</span><span style="font-weight:900">'+totalHT.toFixed(2)+' EUR</span></div>'+
          '<div class="t-row gray"><span>TVA 5,5%</span><span>'+tva.toFixed(2)+' EUR</span></div>'+
          '<div class="t-final"><span class="label">Total TTC</span><span class="amount">'+totalTTC.toFixed(2)+' EUR</span></div>'+
      ...
      (isFacture?
        '<div class="rib">'+
          '<div class="rib-title">R&egrave;glement par virement bancaire</div>'+
          '<div class="rib-grid">'+
      ...
      :
        '<div class="rib">'+
          '<div class="rib-title">Coordonn&eacute;es bancaires pour acompte</div>'+
          '<div class="rib-grid">'+
            '<div class="rib-item"><label>Titulaire</label><span>SAS AEGIA FOOD</span></div>'+
            '<div class="rib-item"><label>Banque</label><span>Banque Populaire Rives de Paris</span></div>'+
            '<div class="rib-item"><label>IBAN</label><span>FR76 1020 7000 8723 2175 3218 077</span></div>'+
      ...
      (dv.notes?'<div class="notes"><div class="notes-title">Notes</div>'+dv.notes+'</div>':'')+

      '<div class="conditions-title">Conditions de r&egrave;glement</div>'+
      '<div class="conditions"> '+(isFacture?'Virement bancaire — 30% vers&eacute; &agrave; la commande, solde &agrave; r&eacute;gler 72h avant la date de l&#39;&eacute;v&eacute;nement.':'30% &agrave; la commande, solde 72h avant l&#39;&eacute;v&eacute;nement. Devis valable 30 jours.')+
      '</div>'+

      '<div style="margin-top:40px;padding-top:12px;border-top:1px solid #EBEBEB">'+
        '<div style="font-size:7.5px;color:#bbb;line-height:1.7;margin-bottom:10px">'+
        ...
        '</div>'+
        '<div style="background:#FF82D7;padding:7px 14px;border-radius:4px;text-align:center;font-size:11px;font-weight:900;letter-spacing:1px;color:#191923">meshuga &mdash; crazy deli &mdash; 3 rue vavin, paris 6e &mdash; hello@meshuga.fr</div>'+
      '</div>'
