...
const INIT_VAULT = [{id:1,title:'Supabase',url:'https://supabase.com',user:'hello@meshuga.fr',pw:''},{id:2,title:'Vercel',url:'https://vercel.com',user:'hello@meshuga.fr',pw:''}]
...
export default function DashboardPage() {
  ...
  const senderSig = isEmy ? 'Emy | B2B Manager | emy@meshuga.fr | +33 6 24 67 78 66' : 'Edward | Big Boss | hello@meshuga.fr | +33 6 58 58 58 01'
  ...
  function generateAndPrintDoc(dv, isFacture) {
    ...
    var mepRow = mep > 0 ? '<tr><td>'+(mepOffert?'<span class="strike">Mise en place / Show cooking</span><span class="offert">OFFERT &#127873;</span>':'Mise en place / Show cooking'+(dv.mep_remise>0?' (-'+dv.mep_remise+'%)':''))+'</td><td style="text-align:center">1</td><td style="text-align:right">'+(mepOffert?'<span class="strike">'+mep.toFixed(2)+' EUR</span>':mepHT.toFixed(2)+' EUR')+'</td><td style="text-align:right">'+(mepOffert?'<span class="offert">0,00 EUR</span>':mepHT.toFixed(2)+' EUR')+'</td></tr>' : ''
    var livRow = liv > 0 ? '<tr><td>'+(livOffert?'<span class="strike">Frais de livraison</span><span class="offert">OFFERT &#127873;</span>':'Frais de livraison')+'</td><td style="text-align:center">1</td><td style="text-align:right">'+(livOffert?'<span class="strike">'+liv.toFixed(2)+' EUR</span>':livHT.toFixed(2)+' EUR')+'</td><td style="text-align:right">'+(livOffert?'<span class="offert">0,00 EUR</span>':livHT.toFixed(2)+' EUR')+'</td></tr>' : ''
    ...
    var css = [
      ...
      '.logo-sub { font-size:8px; color:#aaa; margin-top:3px; letter-spacing:0.5px }',
      ...
      '.offert { color:#009D3A; font-weight:900; font-size:9px; margin-left:5px }',
      ...
      '.notes b { font-family:Yellowtail,cursive; font-size:14px; font-weight:400 }',
      '.cond-title { font-family:Yellowtail,cursive; font-size:14px; color:#191923; margin-bottom:2px }',
      '.cond { font-size:9.5px; color:#555; margin-bottom:14px; line-height:1.6 }',
      '.footer { padding:12px 16mm 8px 16mm; border-top:1px solid #EBEBEB; margin-top:auto }',
    ...
    var mepRow = mep > 0 ? '<tr><td>'+(mepOffert?'<span class="strike">Mise en place / Show cooking</span><span class="offert">OFFERT &#127873;</span>':'Mise en place / Show cooking'+(parseFloat(dv.mep_remise||0)>0?' (-'+dv.mep_remise+'%)':''))+'</td><td style="text-align:center">1</td><td style="text-align:right">'+(mepOffert?'<span class="strike">'+mep.toFixed(2)+' EUR</span>':mepHT.toFixed(2)+' EUR')+'</td><td style="text-align:right;font-weight:900">'+(mepOffert?'<span class="offert">0,00 EUR</span>':mepHT.toFixed(2)+' EUR')+'</td></tr>' : ''
    var livRow = liv > 0 ? '<tr><td>'+(livOffert?'<span class="strike">Frais de livraison</span><span class="offert">OFFERT &#127873;</span>':'Frais de livraison')+'</td><td style="text-align:center">1</td><td style="text-align:right">'+(livOffert?'<span class="strike">'+liv.toFixed(2)+' EUR</span>':livHT.toFixed(2)+' EUR')+'</td><td style="text-align:right;font-weight:900">'+(livOffert?'<span class="offert">0,00 EUR</span>':livHT.toFixed(2)+' EUR')+'</td></tr>' : ''
    ...
    var html = '<!DOCTYPE html><html><head>'+
      ...
      '<div class="page">'+
        '<div class="content">'+
          ...
          '<div class="header">'+
            '<div class="logo">'+
              '<img src="data:image/jpeg;base64," alt="meshuga">'+
              '<div class="logo-sub">Crazy Deli &nbsp;&middot;&nbsp; 3 rue Vavin, 75006 Paris</div>'+
            '</div>'+
            '<div>'+
              '<div class="doc-type">'+titre+'</div>'+
              '<div class="doc-num">N&deg; '+numero+'</div>'+
              '<div class="doc-num">'+new Date().toLocaleDateString('fr-FR')+'</div>'+
            '</div>'+
          '</div>'+
          ...
          '<div class="parties">'+
            ...
            '<div class="party client">'+
              ...
              '<div class="party-name">'+dv.client_nom+'</div>'+
              (dv.client_contact?'<div class="party-detail">'+dv.client_contact+'</div>':'')+
              (dv.client_email?'<div class="party-detail">'+dv.client_email+'</div>':'')+
              ((dv.event_date||dv.event_lieu)?'<div class="party-detail" style="margin-top:5px"><strong>Ev&eacute;nement :</strong> '+(dv.event_date?new Date(dv.event_date).toLocaleDateString('fr-FR'):'')+(dv.event_lieu?' &mdash; '+dv.event_lieu:'')+'</div>':'')+
              '<div class="badge">'+dv.nb_personnes+' personnes</div>'+
            '</div>'+
          '</div>'+

          '<table>'+
            '<thead><tr>'+
              '<th style="text-align:left;width:52%">D&eacute;signation</th>'+
              '<th style="text-align:center;width:10%">Qte</th>'+
              '<th style="text-align:right;width:19%">PU HT</th>'+
              '<th style="text-align:right;width:19%">Total HT</th>'+
            '</tr></thead>'+
            '<tbody>'+items+mepRow+livRow+remiseRow2+'</tbody>'+
          '</table>'+

          '<div class="totals-wrap">'+
            '<div class="totals">'+
              '<div class="t-row"><span>Total HT</span><span style="font-weight:900">'+totalHT.toFixed(2)+' EUR</span></div>'+
              '<div class="t-row gray"><span>TVA 5,5%</span><span>'+tva.toFixed(2)+' EUR</span></div>'+
              '<div class="t-final"><span class="lbl">Total TTC</span><span class="amt">'+totalTTC.toFixed(2)+' EUR</span></div>'+
              '<div class="per-person">soit '+parseFloat(totalTTC/dv.nb_personnes).toFixed(2)+' EUR TTC / personne</div>'+
            '</div>'+
          '</div>'+

          '<div class="rib">'+
            '<div class="rib-title">'+( isFacture ? 'R&egrave;glement par virement bancaire' : 'Coordonn&eacute;es bancaires pour l&#39;acompte' )+'</div>'+
            '<div class="rib-grid">'+
              '<div class="rib-item"><label>Titulaire</label><span>SAS AEGIA FOOD</span></div>'+
              '<div class="rib-item"><label>Banque</label><span>Banque Populaire Rives de Paris</span></div>'+
          ...
          (dv.notes?'<div class="notes"><b>Notes</b><br>'+dv.notes+'</div>':'')+

          '<div class="cond-title">Conditions de r&egrave;glement</div>'+
          '<div class="cond">'+(isFacture?'Virement bancaire &mdash; 30% vers&eacute; &agrave; la commande, solde &agrave; r&eacute;gler 72h avant la date de l&#39;&eacute;v&eacute;nement.':'30% &agrave; la commande, solde &agrave; r&eacute;gler 72h avant la date de l&#39;&eacute;v&eacute;nement. Devis valable 30 jours.')+'</div>'+
        ...
        '<div class="footer">'+
          ...
          '</div>'+
          '<div class="pink-bar">meshuga &mdash; crazy deli &mdash; 3 rue vavin, paris 6e &mdash; hello@meshuga.fr</div>'+
        '</div>'+

      '</div>'+

      '<div class="no-print" style="text-align:center;padding:20px;background:#F8F8F8;border-top:2px solid #EBEBEB">'+
        '<p style="margin-bottom:10px;font-size:11px;color:#888">Dans la fen&ecirc;tre d&#39;impression : d&eacute;cochez <strong>En-t&ecirc;tes et pieds de page</strong>, puis cliquez <strong>Enregistrer en PDF</strong></p>'+
        '<button onclick="document.fonts.ready.then(function(){window.print()})" style="padding:11px 28px;background:#191923;color:#FFEB5A;border:none;border-radius:5px;font-size:13px;font-weight:900;cursor:pointer;letter-spacing:1px">&#128229; Imprimer / Enregistrer en PDF</button>'+
      '</div>'+
              ...
              {!generatingEmail && generatedEmail && (
                <div>
                  ...
                  <div style={{background:'#FFEB5A',border:'2px solid #191923',borderRadius:5,padding:10,fontSize:12,marginTop:8}}>
                    Copie et envoie depuis <strong>{isEmy ? 'emy@meshuga.fr' : 'hello@meshuga.fr'}</strong>
                  </div>
                </div>
              )}
            </div>
