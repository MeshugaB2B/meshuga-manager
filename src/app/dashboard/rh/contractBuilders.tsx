...
export function buildCdiCadreContract(c, emp, logoUri) {
  ...
  body += ''
    ...
    + '<div class="body">'
    + '<p>Le/la Salarié(e) bénéficie de congés payés conformément aux articles L.3141-3 et suivants du Code du travail, à raison de <strong>2,5 jours ouvrables par mois de travail effectif</strong>, dans la limite de 30 jours ouvrables (5 semaines) par an.</p>'
    + '<p>Les dates de congés sont fixées en accord avec l\'Employeur, en tenant compte des nécessités de fonctionnement de l\'établissement. Une demande doit être formulée par écrit au moins 1 mois avant la date souhaitée.</p>'
    + '</div>'
...
function buildCdiSimpleContract(c, emp, logoUri, profil) {
  ...
  var body = ''
    ...
    + '<div class="body">'
    + '<p>2,5 jours ouvrables par mois de travail effectif, dans la limite de 30 jours ouvrables (5 semaines) par an. Les dates sont fixées en accord avec l\'Employeur.</p>'
    + '</div>'
