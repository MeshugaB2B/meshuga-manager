...
export function buildWelcomePack(emp, contract, logoUri) {
  ...
  var styles =
    ...
    "@page { size: A4; margin: 18mm 16mm 20mm 16mm; @bottom-center { content: 'SAS AEGIA FOOD - Dossier de bienvenue Meshuga'; font-family: 'Barlow Condensed', sans-serif; font-size: 9pt; color: #999999; letter-spacing: 1px; text-transform: uppercase; } }" +
  ...
  var page1 =
    '<div class="cover">' +
      ...
      // === CENTRE : Titre Yellowtail blanc + Nom Yellowtail blanc + fonction + embauche ===
      '<div style="position: relative; z-index: 1; flex: 1; display: flex; flex-direction: column; justify-content: center; padding: 8mm 0;">' +
        ...
        '<div style="margin-top: 22mm;">' +
          '<div style="font-family: \'Barlow Condensed\', sans-serif; color: #FFFFFF; opacity: 0.75; font-size: 11pt; font-weight: 700; text-transform: uppercase; letter-spacing: 3px; margin-bottom: 4mm;">' + g('Salarié', 'Salariée') + '</div>' +
          '<div style="font-family: Yellowtail, cursive; color: #FFFFFF; font-weight: 400; font-size: 56pt; line-height: 1; margin-bottom: 8mm;">' + esc(nomComplet) + '</div>' +
          (contract.fonction ? '<div style="font-family: \'Barlow Condensed\', sans-serif; color: #FFFFFF; font-size: 13pt; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 2mm;">' + esc(contract.fonction) + '</div>' : '') +
          (dateEmbaucheFmt ? '<div style="font-family: \'Barlow Condensed\', sans-serif; color: #FFFFFF; opacity: 0.85; font-size: 11pt; font-weight: 600; text-transform: uppercase; letter-spacing: 2px;">Embauche · ' + esc(dateEmbaucheFmt) + '</div>' : '') +
        '</div>' +
      '</div>' +

      // === BAS : Infos AEGIA à gauche + Stamp Meshuga à droite, alignés en bas de page ===
      '<div style="position: relative; z-index: 1; display: flex; justify-content: space-between; align-items: flex-end;">' +
        '<div style="color: #FFFFFF; font-family: \'Barlow Condensed\', sans-serif; font-size: 10pt; line-height: 1.7; font-weight: 500;">' +
          '<div style="font-weight: 800; text-transform: uppercase; letter-spacing: 2px; font-size: 10pt; margin-bottom: 2mm; opacity: 0.85;">Édité le ' + esc(todayFr()) + '</div>' +
  ...
  var page2 =
    '<section class="chapter">' +
        ...
        '<h3 class="bc pink" style="margin-top: 6mm;">Situation familiale <span style="font-weight: 400; font-size: 9pt; text-transform: none; letter-spacing: 0; opacity: 0.6; font-family: Barlow, sans-serif; margin-left: 6px;">(non obligatoire — bonne pratique RH)</span></h3>' +
        ...
        '<h3 class="bc pink" style="margin-top: 6mm;">Personne à prévenir en cas d\'urgence <span style="font-weight: 400; font-size: 9pt; text-transform: none; letter-spacing: 0; opacity: 0.6; font-family: Barlow, sans-serif; margin-left: 6px;">(non obligatoire — fortement recommandé)</span></h3>' +
  ...
  var page3 =
    '<section class="chapter">' +
        ...
        '<div class="legal-box" style="padding: 5px 10px; margin: 1mm 0; font-size: 9pt;">' +
          '<div class="ref" style="font-size: 9pt; margin-bottom: 1px;">Articles L1221-19 à L1221-26 du Code du travail · CCN 1501 art. 9</div>' +
        ...
        (contract.clause_mobilite === true ? (
          ...
          '<div class="legal-box" style="padding: 5px 10px; margin: 1mm 0; font-size: 9pt;">' +
            '<div class="ref" style="font-size: 9pt; margin-bottom: 1px;">Article L1222-6 du Code du travail · jurisprudence Cass. Soc. (zone géographique précise)</div>' +
        ...
        '</div>' +
        '<p style="font-size: 9pt; margin-top: 1mm; line-height: 1.55;">' +
  ...
  var page4 =
    '<section class="chapter">' +
        ...
        '</div>' +
        '<ul class="tidy" style="margin: 1mm 0; font-size: 9pt;">' +
  ...
  var page5 =
    '<section class="chapter">' +
        ...
        '</div>' +
        '<p style="font-size: 9pt; margin: 1mm 0; line-height: 1.55;">' +
  ...
  var page5b =
    '<section class="chapter">' +
        ...
        '<p style="font-size: 9pt; margin: 1mm 0 2mm 0; line-height: 1.55;">' +
        ...
        '<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5mm 6mm; font-size: 9pt; margin-top: 1.5mm;">' +
        ...
        '<div style="margin-top: 2mm; padding: 5px 9px; background: rgba(255,235,90,0.18); border-left: 3px solid #FFEB5A; font-size: 9pt; line-height: 1.55;">' +
          '<div style="font-family: \'Barlow Condensed\', sans-serif; font-weight: 700; font-size: 9pt; text-transform: uppercase; letter-spacing: 1px; color: #191923; margin-bottom: 1px;">⚖ Justification proportionnée de la caméra du poste de cuisson</div>' +
        ...
        '<p style="font-size: 9pt; margin-top: 1.5mm; line-height: 1.55;">' +
  ...
  var page6 =
    '<section class="chapter">' +
        ...
        '</p>' +
        '<div style="margin-top: 1mm; font-size: 9pt; line-height: 1.55;">' +
        ...
        '</p>' +
        '<ol style="margin: 1mm 0 1mm 16px; padding: 0; font-size: 9pt; line-height: 1.55;">' +
        ...
        '<div class="sig-block" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4mm; margin-top: 10mm;">' +
          ...
          '<div style="border: 2.5px solid #FF82D7; border-radius: 6px; padding: 4mm; background: rgba(255,130,215,0.04); position: relative;">' +
            ...
            '</div>' +
            '<div style="margin-top: 2mm; font-family: Barlow Condensed, sans-serif; font-weight: 700; font-size: 9pt; text-align: center;">' + esc(nomComplet) + '</div>' +
          '</div>' +
          ...
          '<div style="border: 2.5px solid #191923; border-radius: 6px; padding: 4mm; background: rgba(25,25,35,0.025); position: relative;">' +
            ...
            '<div style="display: grid; grid-template-columns: auto 1fr; gap: 1mm 4mm; font-size: 9pt; margin-top: 1mm;">' +
              ...
              '<div style="border-bottom: 1px solid #191923; min-height: 14mm; grid-column: 1 / 3;"></div>' +
            '</div>' +
            '<div style="margin-top: 2mm; font-family: Barlow Condensed, sans-serif; font-weight: 700; font-size: 9pt; text-align: center;">Edward TOURET</div>' +
